;;; nojma-theme.el --- A dark theme  -*- lexical-binding:t -*-
...
(custom-theme-set-faces
 'nojma
 '(default ((t (:background "#161616" :foreground "#edc"))))
 ;; Font lock faces
 ...
 '(font-lock-comment-face       ((t (:italic t :slant oblique :foreground "#567"))))

 '(font-lock-doc-face           ((t (:italic t :slant oblique :foreground "LightSalmon"))))
 '(font-lock-doc-markup-face      ((t (:foreground "#a98"))))
 ...
 '(cursor ((t (:background "BlueViolet"))))
 ...
 '(icomplete-selected-match ((t (:background "Cyan2" :foreground "black" :weight bold))))
 ...
 '(region ((t (:background "Wheat4" :foreground "Black" :bold))))
